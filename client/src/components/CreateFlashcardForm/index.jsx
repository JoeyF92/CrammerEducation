...
const CreateFlashcardForm = ({ deckId, cards }) => {
  ...
  return (
    <>
      <img src={client/src/components/CreateFlashcardForm/QA.png} alt="Q&A" className="qa2-image" />
      ...
      <img src={client/src/components/CreateFlashcardForm/QA.png} alt="Q&A" className="qa1-image" />
    </>
  );
};
